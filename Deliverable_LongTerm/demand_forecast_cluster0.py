# %% [markdown]
# # Enhanced Demand Forecasting using CatBoost for Cluster 0 (Low-Demand Economically Independent Materials)
# This script is optimized for materials with relatively stable but low demand that tend to move independently or slightly counter to economic indicators.

# %% [markdown]
# """
# Cluster 0: Low-Demand Economically Independent Materials
# 38 materials (45% of total)

# Characteristics:
# - Lowest average monthly demand (361 units)
# - Moderate demand variability (CV = 0.67)
# - High order fulfillment rate
# - Negative correlation with all economic indicators:
#   * Negative PIB sensitivity (-0.14)
#   * Negative ICI sensitivity (-0.15)
#   * Negative market sensitivity (ECG: -0.10, ISE: -0.12)

# This cluster represents materials with relatively stable but low demand that tend to move 
# independently or slightly counter to economic indicators. Their demand patterns suggest
# they might be essential or maintenance-related materials that are needed regardless of 
# economic conditions.

# Strategy:
# - Focus on maintaining efficient inventory levels due to stable, predictable demand
# - Consider economic downturns as potential opportunity periods
# - Monitor order fulfillment rate to maintain high service levels
# """
...
def prepare_features(data, monthly_data, is_training=True):
    """
    Prepare features optimized for Cluster 0 - emphasizing stability and economic indicators
    """
...
def train_model(X_train, y_train, X_val, y_val):
    """
    Train CatBoost model optimized for Cluster 0 - Stable Mid-Volume Products
    """
