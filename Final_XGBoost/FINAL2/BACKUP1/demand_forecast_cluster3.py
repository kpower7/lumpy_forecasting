# %% [markdown]
# # Generic XGBoost Demand Forecasting Method
# This script implements a general-purpose XGBoost-based demand forecasting approach that can be adapted to various material types.
...
def train_model(X_train: pd.DataFrame, y_train: pd.Series, 
    ...
    Notes:
    - Uses generally effective default parameters
    - Includes early stopping if validation data provided
    - Returns best model based on validation performance
    """
