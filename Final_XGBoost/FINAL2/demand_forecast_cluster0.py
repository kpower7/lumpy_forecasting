# %% [markdown]
# # Enhanced Demand Forecasting using XGBoost for Cluster 0 (Low-Demand Economically Independent Materials)
...
def train_model(X_train, y_train, X_val, y_val):
    """
    Train XGBoost model optimized for Cluster 0 - Stable Mid-Volume Products
    """
