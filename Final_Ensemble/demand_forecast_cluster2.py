# %% [markdown]
# # Enhanced Demand Forecasting using XGBoost-CatBoost Ensemble for Cluster 2
# This script uses an ensemble of XGBoost and CatBoost models for improved prediction accuracy
...
def train_ensemble_model(X_train, y_train, X_val, y_val):
    """
    Train both XGBoost and CatBoost models and create an ensemble
    """
    # Train XGBoost model
...
def predict_ensemble(xgb_model, cat_model, X):
    """
    Make predictions using both models and average them
    """
...
def main(material_id, material_no, output_path=None):
    ...
    try:
        ...
        xgb_model, cat_model = train_ensemble_model(X_train, y_train, X_val, y_val)
        
        # Make ensemble predictions
        test_pred = predict_ensemble(xgb_model, cat_model, X_test)
