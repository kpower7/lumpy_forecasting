# %% [markdown]
# # Enhanced Demand Forecasting using XGBoost-CatBoost Ensemble for Cluster 0 (Low-Demand Economically Independent Materials)
...
def plot_monthly_forecast(predicted, actual, material_id, material_no, output_path):
...
def main(material_id, material_no, output_path=None):
    ...
    try:
        ...
        plot_monthly_forecast(monthly_pred, monthly_actual, material_id, material_no, output_path)
