# %% [markdown]
# # Enhanced Demand Forecasting using XGBoost-CatBoost Ensemble for Cluster 3
...
# %% [markdown]
"""
Generic XGBoost Demand Forecasting
================================

This implementation provides a flexible, data-driven approach to demand forecasting
using XGBoost (eXtreme Gradient Boosting). The model automatically learns patterns
...
def evaluate_model(model, X, y, period: str = 'All') -> dict:
    """
